...
* [Generic CDI Portlet](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Development_Guide/GenericPortlet_and_Portlet_Filter_Injection.html)
...
3. Type this command to build and deploy the archive:
   ...
   This will deploy `target/cdi-generic-portlet.war` to the running instance of the portal.
...
see the newly imported CDI Generic Portlet under the Quickstarts Category.
* Then you can add the example portlet to a page of your choice: either (a) to a new page or (b) to an existing page.
    * If you have chosen (a) to add the portlet to a new page:
        ...
        * In the Page Creation Wizard, fill in:
            * Node Name: cdi-generic-portlet
            * Display Name: CDI Generic Portlet
        * Click Next
        * Leave Empty Layout as it is and hit Next
        * Drag-and-Drop CDI Generic Portlet from the Page Editor dialog to the middle of the Page Creation Wizard
    ...
    * If you have chosen (b) to add the portlet to an existing page:
        ...
        * Drag-and-Drop CDI Generic Portlet from the Page Editor dialog to a place of your choice within the page.
        * Click the Diskette-like Finish button in the header of the Page Editor dialog and see the newly added portlet in action.
