<!--~ Do not edit this derived file! See gatein-portal-quickstarts-parent/src/main/freemarker/cdi-scope-portlets/README.md.ftl ~-->

cdi-scope-portlets: Portlets Using CDI Scopes
============================
Author: Ken Finnigan  
Level: Intermediate  
Technologies: Portlet, CDI  
Summary: Portlets Using CDI Scopes @PortletLifecycleScoped and @PortletRedisplayScoped.  
...
* [Using CDI Scopes in Portlets](https://docs.jboss.org/author/display/GTNPORTAL36/Using+CDI+Scopes+in+Portlets)
...
3. Type this command to build and deploy the archive:
   ...
   This will deploy `target/cdi-scope-portlets.war` to the running instance of the portal.
...
see the newly imported Portlets Using CDI Scopes under the cdi-scope-portlets Category.
* Then you can add the example portlet to a page of your choice: either (a) to a new page or (b) to an existing page.
    * If you have chosen (a) to add the portlet to a new page:
        ...
        * In the Page Creation Wizard, fill in:
            * Node Name: cdi-scope-portlets
            * Display Name: Portlets Using CDI Scopes
        * Click Next
        * Leave Empty Layout as it is and hit Next
        * Drag-and-Drop Portlets Using CDI Scopes from the Page Editor dialog to the middle of the Page Creation Wizard
    ...
    * If you have chosen (b) to add the portlet to an existing page:
        ...
        * Drag-and-Drop Portlets Using CDI Scopes from the Page Editor dialog to a place of your choice within the page.
        * Click the Diskette-like Finish button in the header of the Page Editor dialog and see the newly added portlet in action.
