...
<div class="CDIScopesPortlet">
    ...
    <p>
        ...
        <a id="gatein.devguide.cdi.scope.portlets.url" href="http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Portlet_CDI_Scopes">Portlet CDI Scopes</a>
