...
<div class="CDIScopesPortlet">
    ...
    <p>
        ...
        <a id="gatein.devguide.cdi.scope.portlets.url" href="http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Development_Guide/sect-Portlet_CDI_Scopes.html">Portlet CDI Scopes</a>
