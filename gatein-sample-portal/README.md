...
For more details, see [Portal Containers](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Development_Guide/chap-Portal_Containers.html) page of
...
The `standalone.xml` available in the out-of-the-box JBoss Portal Platform 6.1 installation contains the needed pieces
...
> described in [JBoss EAP 6.1 Admin Guide](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Enterprise_Application_Platform/6.1/html/Administration_and_Configuration_Guide/chap-Datasource_Management.html)

[*] Datasources can be defined in EARs but such ones are not managed, see
[JBoss EAP 6.1 Admin Guide](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Enterprise_Application_Platform/6.1/html/Administration_and_Configuration_Guide/chap-Datasource_Management.html#Deployment_of_-ds.xml_files).
