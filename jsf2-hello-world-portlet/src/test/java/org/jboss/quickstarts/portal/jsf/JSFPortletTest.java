...
public class JSFPortletTest {
    ...
    public static PortletArchive getDeployment() {
        PortletArchive archive = ShrinkWrap.create(PortletArchive.class, "jsf2-hello-world-portlet-tests.war");
        ...
        archive.createFacesPortlet("jsf2HelloWorldPortletTests", "JSF2 Hello World Portlet Tests", "main.xhtml");
        File f = new File("src/main/webapp/pages/main.xhtml");
        System.out.println(f.getAbsolutePath() +" exists = "+ f.exists());
        archive.addAsWebResource(f, "main.xhtml");
        archive.addClass(HelloBean.class);
