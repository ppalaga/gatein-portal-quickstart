<!--~ Do not edit this derived file! See jboss-portal-quickstarts/src/main/freemarker/jsf2-portlet-with-tests/README.md.ftl ~-->

jsf2-portlet-with-tests: JSF2 Portlet with Tests
============================
Author: Peter Palaga, Brian Leathem, Ken Finnigan  
Level: Beginner  
Technologies: JSF2, Portlet Bridge  
Summary: A simple JSF2 portlet with tests.with tests.  
...
This project demonstrates how to create A simple JSF2 portlet with tests.with tests.1
...
3. Type this command to build and deploy the archive:
   ...
   This will deploy `target/jsf2-portlet-with-tests.war` to the running instance of the portal.
...
see the newly imported JSF2 Portlet with Tests under the Quickstarts Category.
* Then you can add the example portlet to a page of your choice: either (a) to a new page or (b) to an existing page.
    * If you have chosen (a) to add the portlet to a new page:
        ...
        * In the Page Creation Wizard, fill in:
            * Node Name: jsf2-portlet-with-tests
            * Display Name: JSF2 Portlet with Tests
        * Click Next
        * Leave Empty Layout as it is and hit Next
        * Drag-and-Drop JSF2 Portlet with Tests from the Page Editor dialog to the middle of the Page Creation Wizard
    ...
    * If you have chosen (b) to add the portlet to an existing page:
        ...
        * Drag-and-Drop JSF2 Portlet with Tests from the Page Editor dialog to a place of your choice within the page.
        * Click the Diskette-like Finish button in the header of the Page Editor dialog and see the newly added portlet in action.
