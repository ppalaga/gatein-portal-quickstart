...
public class JSFPortletTest {
    ...
    public static PortletArchive getDeployment() {
        PortletArchive archive = ShrinkWrap.create(PortletArchive.class, "jsf2-portlet-with-tests.war");
        ...
        archive.createFacesPortlet("jsf2PortletWithTests", "JSF2 Portlet with Tests", "main.xhtml");
