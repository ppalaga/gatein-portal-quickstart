...
chapter [OAuth - Authentication with social network accounts](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/OAuth_-_Authentication_with_social_network_accounts) in JBoss Portal Platform
...
[Portal API](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Portal+API) to obtain informations about access token of current user. Filter saves this info
...
* [Starting a Portlet Project](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Development_Guide/Portlet_Development.html#Starting_a_Portlet_Project)
* [Standard Portlet Development (JSR-286)](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Development_Guide/Standard_Portlet_Development_JSR-286.html)
* [Portal API](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Portal+API)
...
* [OAuth - Authentication with social network accounts](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/OAuth_-_Authentication_with_social_network_accounts)
* [Facebook](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Facebook)
* [Google+](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Google_Plus)
* [Twitter](http://documentation-devel.engineering.redhat.com/docs/en-US/JBoss_Portal_Platform/6.1/html/Twitter)
